...
import { PageType, SiteSettings, PortfolioItem, AppState } from './types';
import { INITIAL_SETTINGS, INITIAL_PORTFOLIO } from './constants';
        ...
        <>
          ...
          <section className="py-24 bg-gradient-to-b from-black to-[#050505]">
            <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-12">
              <div className="flex flex-col gap-4 p-8 rounded-3xl bg-white/5 border border-white/10 hover:border-purple-500/50 transition-all group">
                ...
                <p className="text-gray-400">단순히 예쁜 디자인을 넘어, 브랜드의 철학을 담은 전략적 아이덴티티를 제안합니다.</p>
              </div>
              <div className="flex flex-col gap-4 p-8 rounded-3xl bg-white/5 border border-white/10 hover:border-purple-500/50 transition-all group">
                ...
                <p className="text-gray-400">최신 기술 스택을 활용하여 놀라운 속도와 성능을 갖춘 디지털 결과물을 제작합니다.</p>
              </div>
              <div className="flex flex-col gap-4 p-8 rounded-3xl bg-white/5 border border-white/10 hover:border-purple-500/50 transition-all group">
                ...
                <p className="text-gray-400">비즈니스의 성장에 따라 유연하게 확장 가능한 견고한 아키텍처를 지향합니다.</p>
              </div>
            </div>
          </section>
          ...
          <section className="py-24 bg-black">
             <div className="max-w-4xl mx-auto px-6 text-center">
                ...
                <p className="text-gray-500 mb-12 text-lg">상담 신청 후 24시간 이내에 답변을 드립니다. 지금 바로 시작해보세요.</p>
